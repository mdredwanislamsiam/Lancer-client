		...
		<form className="space-y-4 mt-5" onSubmit={handleSubmit(onSubmit)}>
			...
			<div>
				<label className="label font-medium">
					<span className="label-text text-xs lg:text-sm">Rating</span>
				</label>
			...
			<div className="form-control">
				<label className="label font-medium">
					<span className="label-text text-xs lg:text-sm">Your Review</span>
				</label>
				<div>
					<textarea
						{...register("comment", { required: true })}
						className="textarea font-newfont1 textarea-bordered  text-xs lg:text-sm min-h-[120px] focus:textarea-primary outline-none w-full"
			...
			<button type="submit" className="btn btn-xs lg:btn-lg btn-primary w-full md:w-auto" disabled={isSubmitting}>
				{isSubmitting ?
					<>
