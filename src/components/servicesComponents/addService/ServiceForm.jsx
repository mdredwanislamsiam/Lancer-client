...
const ServiceForm = () => {
    ...
    return (
		<div className="w-1/2 mx-auto">
			<h1 className="text-3xl font-bold my-10 text-center">Service Form</h1>
			<form onSubmit={handleSubmit(addService)} className="space-y-4">
				...
				<div>
					<label className="block text-sm font-medium">Service Requirments</label>
					<textarea
				...
				<div className="flex  gap-1 w-full justify-between">
					{/* Weeks */}
					<div>
						<label className="block text-sm font-medium">Delivery Weeks</label>
						<input
							type="number"
					...
					{/* Hours */}
					<div>
						<label className="block text-sm font-medium">Delivery Hours</label>
						<input
							type="number"
